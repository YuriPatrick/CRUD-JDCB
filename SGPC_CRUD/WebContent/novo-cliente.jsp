...
<jsp:include page="home.jsp" />
	<form action="salva-cliente" method="post" name="form1">
			...
			<p class="p-novo-cliente">Cadastro de Clientes</p>
				<div class="div-interna-novo-cliente">
					<table>
						...
						<tr>
							<td>CPF</td>
							<td><input type="text" id="cpfClie" class="input-novo-cliente form-control cpf-mask" name="cpfClie" placeholder="Ex.: 000.000.000-00">
							</td>
						</tr>
						<tr>
		...
		<p id="p-mensagem-sucesso" class="sucesso-msg" ${msg_resultado}> 
		</p>
	</form>
